...
const servicesDetails = {
  ...
  hotWater: {
    icon: "hotWater",
    title: "Гаряча вода",
    subtitle: "Сервіс систем ГВП",
    description: "Сервісні інженери LQD виконують регулярне обслуговування систем приготування гарячої води у приватних будинках. Працюємо з підлоговими бойлерами Buderus, Flamco, Huch, Tesy, Drazice та іншим обладнанням ГВП.\n\nПід час сервісу перевіряємо технічний стан бойлера, захисних елементів, електротенів, анодів та вузлів безпеки. За потреби виконуємо очищення, дезінфекцію внутрішнього бака й підготовку системи до стабільної роботи.",
    includedItems: [
      "Діагностика системи гарячої води",
      "Перевірка стану бойлера",
      "Контроль і заміна захисних анодів",
      "Перевірка та заміна електротенів",
      "Оцінка стану внутрішньої емалі",
      "Очищення та дезінфекція бака",
      "Перевірка запобіжних клапанів",
      "Перевірка розширювальних баків",
      "Контроль захисного обладнання ГВП"
    ]
  },
  automation: {
    icon: "automation",
